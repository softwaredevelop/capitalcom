...
func defineInfrastructure(ctx *pulumi.Context) (*GithubResource, error) {
	repositoryName := "capitalcom"
	repositoryDescription := "A Python framework for developing, analyzing, and executing trading strategies using the Capital.com API."
	repository, err := github.NewRepository(ctx, "newRepositoryCapitalcom", &github.RepositoryArgs{
